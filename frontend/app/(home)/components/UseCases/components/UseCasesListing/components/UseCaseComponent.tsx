        ...
        <Fragment key={d.question}>
          ...
          <div className="flex">
            <div className="bg-[#E0DDFC] max-w-[75%] rounded-xl p-4">
              <span className="text-[#8F8F8F] text-xs">@Cortx</span>
              <p>{d.answer}</p>
            </div>
          </div>
        </Fragment>
      ))}
      <div className="flex flex-col w-full shadow-md dark:shadow-primary/25 hover:shadow-xl transition-shadow rounded-xl bg-secondary dark:bg-black border border-black/10 dark:border-white/25 p-4 mt-10">
