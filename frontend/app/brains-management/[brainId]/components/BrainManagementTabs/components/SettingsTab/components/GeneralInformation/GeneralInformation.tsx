      ...
      <div className="grid grid-cols-1 md:grid-cols-2 justify-between w-full items-end">
        ...
        <div className="mt-4">
          <div className="flex flex-1 items-end flex-col">
            ...
            <div>
              {isDefaultBrain ? (
                <div className="border rounded-lg border-dashed border-black dark:border-white bg-secondary dark:bg-black text-black dark:text-white focus:bg-black dark:focus:bg-secondary dark dark focus:text-white dark:focus:text-black transition-colors py-2 px-4 shadow-none">
