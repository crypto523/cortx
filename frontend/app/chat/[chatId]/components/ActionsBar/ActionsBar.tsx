...
export const ActionsBar = (): JSX.Element => {
  ...
  return (
    <>
      {hasPendingRequests && (
        <div className="flex mt-1 flex-col md:flex-row w-full shadow-md dark:shadow-primary/25 hover:shadow-xl transition-shadow rounded-xl bg-secondary dark:bg-black border border-black/10 dark:border-white/25 p-2 md:p-6 pl-6 mb-3">
      ...
      <div>
        {shouldDisplayFeedCard && (
          <AnimatePresence>
            ...
            >
              <div className="flex flex-1 overflow-y-auto shadow-md dark:shadow-primary/25 hover:shadow-xl transition-shadow rounded-xl bg-secondary dark:bg-black border border-black/10 dark:border-white/25 p-4 md:p-6 mt-5">
                <KnowledgeToFeed
