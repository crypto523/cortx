...
export const NotificationDisplayer = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row bg-secondary p-2 rounded-sm ml-2">
      ...
      {isHovered && (
        <div
          className="absolute bg-secondary p-2 rounded-sm border border-gray-100 shadow-sm transition-transform transform translate-y-1 translate-x-1/4 z-10"
