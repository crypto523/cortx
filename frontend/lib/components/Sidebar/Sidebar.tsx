  ...
  return (
    <MotionConfig transition={{ mass: 1, damping: 10, duration: 0.2 }}>
      <motion.div
        ...
        className="flex flex-col fixed sm:sticky top-0 left-0 h-full overflow-visible z-30 border-r border-black/10 dark:border-white/25 bg-secondary dark:bg-black"
      >
        {!open && (
          <button
            title="Open Sidebar"
