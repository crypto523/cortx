  ...
  return (
    <>
      <div className="flex gap-2 w-full">
        <select
          className="block w-32 px-3 py-2 bg-secondary border border-gray-300 rounded-md shadow-sm focus:outline-none focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
          defaultValue="GET"
          disabled={readOnly}
      ...
      <Root
        className="flex flex-col w-full h-full overflow-scroll bg-secondary dark:bg-black py-4 md:py-10 max-w-5xl"
        value={selectedTab}
      >
