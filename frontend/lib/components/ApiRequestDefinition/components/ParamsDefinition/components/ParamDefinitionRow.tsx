  ...
  return (
    <div className="flex flex-1 justify-between items-center py-4 border-b border-gray-300 relative gap-2">
      ...
      <div className="flex-1">
        <select
          id={`type-${index}`}
          className="mt-1 block w-full py-2 px-3 border border-gray-300 dark:bg-gray-800 dark:text-gray-100 bg-secondary dark:border-gray-800 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
          disabled={isApiDefinitionReadOnly}
          {...register(
