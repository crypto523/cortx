            ...
            <TooltipPrimitive.Portal forceMount>
              <TooltipPrimitive.Content sideOffset={5} asChild>
                <motion.div
                  ...
                  className="select-none rounded-md border border-black/10 dark:border-white/25 bg-secondary dark:bg-gray-800 px-5 py-3 text-sm leading-none shadow-lg dark:shadow-primary/25"
                >
                  {tooltip}
