  ...
  ({ children, className, ...props }: CardProps, ref): JSX.Element => {
    return (
      <div
        ...
        className={cn(
          "shadow-md dark:shadow-primary/25 hover:shadow-xl transition-shadow rounded-xl overflow-hidden bg-secondary dark:bg-black border border-black/10 dark:border-white/25",
          className
        )}
        {...props}
      >
