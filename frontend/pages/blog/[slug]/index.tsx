...
const BlogPostDetail = ({ post }: InferGetStaticPropsType<typeof getStaticProps>) => {
  ...
  return (
    <section className="w-full">
      <header className="bg-secondary text-zinc-900 py-4 border-b">
        <div className="container mx-auto px-4 md:px-6">
          <nav className="flex items-center justify-between">
            <Link href="/blog">
              <div className="text-2xl font-bold cursor-pointer">Cortx</div>
            </Link>
            <div className="space-x-4">
              <Link className="text-zinc-900 hover:text-zinc-700" href="https://quivr.app">Try Cortx</Link>
            </div>
          </nav>
        </div>
      </header>
      <div className="px-4 py-6 md:px-6 lg:py-16 md:py-12 bg-secondary dark:bg-black">
        <Head>
