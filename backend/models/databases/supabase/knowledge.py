...
class Knowledges(Repository):
    ...
    def insert_knowledge(self, knowledge: CreateKnowledgeProperties) -> Knowledge: # type: ignore
        """
        Add a knowledge
        """
    ...
    def remove_knowledge_by_id( # type: ignore
    ...
    def get_knowledge_by_id(self, knowledge_id: UUID) -> Knowledge: # type: ignore
        """
    ...
    def get_all_knowledge_in_brain(self, brain_id: UUID) -> List[Knowledge]: # type: ignore
        """
