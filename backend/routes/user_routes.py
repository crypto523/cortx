...
async def get_user_endpoint(
    ...
    max_brain_size = userSettings.get("max_brain_size", 1000000000)  # type: ignore

    date = time.strftime("%Y%m%d")
    daily_chat_credit = userSettings.get("daily_chat_credit", 10)  # type: ignore
    ...
    return {
        ...
        "models": userSettings.get("models", []),  # type: ignore
        "date": date,
        "id": current_user.id,
    }
